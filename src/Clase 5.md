...
- Nosotros podemos armar una computadora y nunca conectarla a una red. En GCP esto no puede pasar nunca, ya que toda VM debe $\in$ a una VPC, no puede $\exists$ sin una red asociada.
